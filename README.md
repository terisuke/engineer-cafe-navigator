...
│   │   │   ├── VoiceInterface.tsx    # 音声UI
│   │   │   ├── MarpViewer.tsx        # スライド表示
│   │   │   ├── CharacterAvatar.tsx   # 3Dキャラ
│   │   │   └── LanguageSelector.tsx  # 言語選択
│   │   └── page.tsx                  # メインページ
│   ├── mastra/                       # Mastra設定
│   │   ├── agents/                   # AI エージェント
│   │   │   ├── welcome-agent.ts      # 案内エージェント
│   │   │   ├── qa-agent.ts          # Q&Aエージェント
│   │   │   └── realtime-agent.ts    # リアルタイム処理
│   │   ├── tools/                    # Mastra Tools
│   │   │   ├── slide-control.ts      # スライド制御
│   │   │   ├── marp-renderer.ts      # Marpレンダリング
│   │   │   └── character-control.ts  # キャラ制御
│   │   └── voice/                    # 音声サービス
│   │       └── google-cloud-voice.ts # GCP音声統合
│   ├── slides/                       # スライドコンテンツ
│   │   ├── engineer-cafe.md          # メインスライド
│   │   ├── narration/                # ナレーション
│   │   │   ├── engineer-cafe-ja.json # 日本語
│   │   │   └── engineer-cafe-en.json # 英語
│   │   └── themes/                   # カスタムテーマ
